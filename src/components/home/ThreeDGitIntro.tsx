  ...
  return (
    <section className="relative isolate overflow-hidden border-b border-slate-200 bg-white">
      ...
      <div className="mx-auto grid min-h-[calc(100dvh-73px)] max-w-7xl items-center gap-10 px-4 py-14 md:px-6 lg:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)] lg:py-16">
        ...
        <div className="scene-stage motion-delay-1 relative min-h-[420px] md:min-h-[560px]">
          <div className="absolute inset-x-4 bottom-8 h-24 rounded-lg border border-slate-200 bg-slate-100/80 shadow-[0_24px_80px_rgba(15,23,42,0.16)] blur-sm" />
